...
const ContactUs = ({ setSelectedPage }: Props) => {
  const inputStyles = `mb-5 rounded-lg bg-primary-300 w-full py-3 px-5 placeholder-white`
        ...
        <div className="mt-10 justify-between gap-8 md:flex">
          ...
          >
            <form
              target="_blank"
              onSubmit={onSubmit}
              action="https://formsubmit.co/theallisonlai@email.com"
              method="POST"
            >
              <input
          ...
          >
            <div className="before:absolute before:content-evolvetext before:z-[-1] before:-bottom-20 before:-right-10">

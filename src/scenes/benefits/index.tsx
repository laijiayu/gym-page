            ...
            >
                ...
                >
                    {benefits.map((benefit: BenefitType) => {
                        return <Benefit key={benefit.title} icon={benefit.icon} title={benefit.title} description={benefit.description} setSelectedPage={setSelectedPage} />
                    })}
                ...
                <div className="mt-16 items-center justify-between gap-20 md:mt-28 md:flex">
                    {/* GRAPHICS */}
                    <img src={BenefitsPageGraphic} alt="benefit-page-graphic" className="m-auto" />
